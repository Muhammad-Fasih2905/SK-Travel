  ...
  return (
    <>
        ...
        <div className="relative mx-auto max-w-6xl px-5 pb-20 pt-16 sm:px-8 sm:pb-28 sm:pt-24">
          <Reveal>
            ...
            <div className="mt-9 flex flex-wrap items-center gap-4">
              <Link
                href="/packages"
                className="group inline-flex items-center gap-2 rounded-full bg-coral px-6 py-3.5 text-[15px] font-semibold text-linen transition-all hover:-translate-y-0.5 hover:bg-coral-dark hover:shadow-lg hover:shadow-coral/25"
              >
                Browse packages
              ...
              <a
                href={site.phoneHref}
                className="inline-flex items-center gap-2 rounded-full border border-linen/25 px-6 py-3.5 text-[15px] font-semibold text-linen transition-all hover:-translate-y-0.5 hover:border-linen/60"
              >
      ...
      <section className="border-b border-deep/10 bg-linen-2">
        <RevealGroup className="mx-auto grid max-w-6xl grid-cols-2 gap-6 px-5 py-10 sm:px-8 md:grid-cols-4">
          {stats.map((s) => (
            <RevealItem key={s.label} className="flex items-start gap-3">
      ...
      <section className="bg-deep-dark text-linen">
        <div className="mx-auto max-w-6xl px-5 py-20 sm:px-8">
          ...
          <RevealGroup className="mt-12 grid gap-10 sm:grid-cols-3" stagger={0.12}>
            {[
              {
              ...
              <RevealItem key={step.title} className="border-t border-linen/15 pt-6">
      ...
      {/* CTA */}
      <section className="mx-auto max-w-6xl px-5 py-20 sm:px-8">
        <Reveal className="flex flex-col items-start justify-between gap-8 rounded-3xl bg-amber/15 px-8 py-12 sm:flex-row sm:items-center sm:px-12">
          <div>
          ...
          <a
            ...
            className="inline-flex shrink-0 items-center gap-2 rounded-full bg-deep px-6 py-3.5 text-[15px] font-semibold text-linen transition-all hover:-translate-y-0.5 hover:bg-deep-dark hover:shadow-lg hover:shadow-deep/25"
          >
